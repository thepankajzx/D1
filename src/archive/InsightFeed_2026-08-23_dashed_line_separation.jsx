...
function getBadgeIcon(badgeLabel = '') {
  ...
  if (label.includes('DUO')) return <Icon name="join_inner" className="text-[12px] shrink-0" />;
  if (label.includes('DRAIN')) return <Icon name="battery_alert" className="text-[12px] shrink-0" />;
  if (label.includes('KEYSTONE')) return <Icon name="auto_awesome" className="text-[12px] shrink-0" />;
  if (label.includes('COMEBACK') || label.includes('HERO') || label.includes('BOUNCE')) return <Icon name="offline_bolt" className="text-[12px] shrink-0" />;
  if (label.includes('RISING') || label.includes('STAR')) return <Icon name="trending_up" className="text-[12px] shrink-0" />;
  if (label.includes('ATTENTION') || label.includes('NEED')) return <Icon name="trending_down" className="text-[12px] shrink-0" />;
  if (label.includes('SUNDAY') || label.includes('SLUMP')) return <Icon name="event_busy" className="text-[12px] shrink-0" />;
  if (label.includes('MONDAY') || label.includes('CHAMPION')) return <Icon name="emoji_events" className="text-[12px] shrink-0" />;
  if (label.includes('GOLDEN') || label.includes('HOUR')) return <Icon name="schedule" className="text-[12px] shrink-0" />;
  if (label.includes('SURGE')) return <Icon name="bolt" className="text-[12px] shrink-0" />;
  return <Icon name="insights" className="text-[12px] shrink-0" />;
}
            ...
            >
              <div className="flex items-center justify-between gap-2 flex-wrap">
                <div className="flex items-center gap-2">
                  <span className={'px-2 py-0.5 rounded-md text-[9.5px] font-extrabold uppercase tracking-wider border flex items-center gap-1 ' + arch.badgeClass}>
                    <Icon name={arch.icon} className="text-[11px]" />
