...
const TARGET = 'g:\\STITCH HABIT TRACKER\\definite-habit-tracker\\src\\pages\\RecoveryDeepDive.jsx';
...
const lines = [
  ...
  "            </div>",
  "            <h1 className=\"text-xl sm:text-2xl md:text-3xl font-black text-white tracking-tight truncate\">{habit.name}</h1>",
  "          </div>",
  "          <button type=\"button\" onClick={() => setShowInfo(true)} className=\"w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-orange-950/60 hover:bg-orange-900/80 text-orange-400 flex items-center justify-center border border-orange-500/30 cursor-pointer flex-shrink-0\">",
  ...
  "            <div className=\"w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-[#281508] border border-orange-500/30 text-orange-500 flex items-center justify-center flex-shrink-0\"><ShieldCheck size={28} weight=\"fill\" /></div>",
  "            <div className=\"flex flex-col min-w-0\">",
  "              <span className=\"text-[11px] sm:text-xs font-extrabold uppercase tracking-wider text-orange-400\">Resilience Score</span>",
  "              <span className=\"text-xs sm:text-sm text-stone-300 font-medium mt-0.5 truncate\">7-day comeback and bounce-back rate</span>",
  "            </div>",
  "          </div>",
  "          <div className=\"flex flex-col items-end flex-shrink-0 text-right\">",
  "            <div className=\"text-2xl sm:text-3xl md:text-4xl font-black text-orange-500 leading-tight\">{recoveryScore !== null && recoveryScore !== undefined ? recoveryScore + '%' : '\\u2014'}</div>",
  "            <span className=\"text-[11px] sm:text-xs text-orange-200/80 font-bold tracking-wide mt-0.5 capitalize\">{recoveryScore >= 80 ? 'High' : recoveryScore >= 50 ? 'Moderate' : 'Needs Work'}</span>",
  "          </div>",
  "        </div>",
  "      </section>",
  "",
  ...
  "          {label:'Win Rate', val:winRate+'%', unit:'', sub:recoveredMisses.length+' of '+totalMisses+' resolved', IC:<CheckCircle size={18} weight=\"fill\"/>, ibg:'bg-emerald-50 text-emerald-600', vc:'text-emerald-600'}",
...
console.log('Done. Size:', fs.statSync(TARGET).size, 'bytes,', lines.length, 'lines');
