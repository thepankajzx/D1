...
export default function InsightFeed() {
  ...
  // 4 Main Dropdown Sections State: Today, Weekly, 14 Days, 30 Days
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-col gap-2">
          ...
          <div>
            ...
            >
              <span>{isHinglish ? 'इंसाइड्स फ़ीड' : 'Daily Insight Feed'}</span>
              <span 
      ...
      {/* ── 4 Dropdown / Accordion Sections (Today, Weekly, 14 Days, 30 Days) ── */}
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'clamp(1rem, 2vw, 1.75rem)' }}>
        ...
        {sectionsConfig.map((section) => {
          ...
          return (
            ...
            >
              {/* Dropdown Header Bar (Tap to toggle) */}
              <div 
      ...
      <div className="relative w-full max-w-[460px] max-h-[85vh] bg-white dark:bg-[#131722] rounded-3xl p-5 sm:p-6 shadow-2xl border border-slate-200 dark:border-slate-800 z-10 flex flex-col overflow-hidden animate-in zoom-in-95 duration-150 space-y-3.5">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="text-[10px] text-slate-400 font-medium">
                {isHinglish ? 'Today, 7D, 14D & 30D एनालिसिस गाइड' : '4-timeframe behavioral discovery engine'}
              </span>
            </div>
          </div>
          <button 
        ...
        <div className="space-y-2 overflow-y-auto pr-0.5 text-xs text-slate-600 dark:text-slate-300">
          <div className="p-2.5 rounded-xl bg-amber-50/60 dark:bg-amber-950/20 border border-amber-100 dark:border-amber-900/40">
            <strong className="text-amber-800 dark:text-amber-300 font-bold block mb-0.5">⚡ Today's Insights</strong>
            <p>आज के ट्रिगर्स और तुरंत बनने वाले मोमेंटम पैटर्न्स।</p>
          </div>
          <div className="p-2.5 rounded-xl bg-emerald-50/60 dark:bg-emerald-950/20 border border-emerald-100 dark:border-emerald-900/40">
            <strong className="text-emerald-800 dark:text-emerald-300 font-bold block mb-0.5">📅 Weekly (7 Days)</strong>
            <p>7 दिनों के राइजिंग स्टार्स, स्लिप्स और रिबाउंड ट्रेंड्स।</p>
          </div>
          <div className="p-2.5 rounded-xl bg-sky-50/60 dark:bg-sky-950/20 border border-sky-100 dark:border-sky-900/40">
            <strong className="text-sky-800 dark:text-sky-300 font-bold block mb-0.5">🔄 14-Day Trajectory</strong>
            <p>दो हफ्तों का तुलनात्मक विश्लेषण और रूटीन का पक्का होना।</p>
          </div>
          <div className="p-2.5 rounded-xl bg-purple-50/60 dark:bg-purple-950/20 border border-purple-100 dark:border-purple-900/40">
            <strong className="text-purple-800 dark:text-purple-300 font-bold block mb-0.5">📊 30-Day Monthly</strong>
            <p>Power Duos, Keystone Habits और वीकेंड/वीकडे एनोमलीज़।</p>
          </div>
        </div>
